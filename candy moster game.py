...
directions = canvas.create_text(200,250,text='Collect candy but avoid the red ones', fill='white', font=('Helvetica', 20))
directions2 = canvas.create_text(200,300,text='Use Arrow Keys to move the character', fill='white', font=('Helvetica', 20))
...
# Function checks if not on edge and updates x coordinates based on right/left and y coordinates based on up/down
def move_character():
...
window.after(2000, end_title) # destroy title and instructions
window.after(2000, make_candy) # start making candy
window.after(2000, move_candy) # start moving candy
window.after(2000, check_hits) # check if character hit a candy
window.after(2000, move_character) # handle keyboard controls
